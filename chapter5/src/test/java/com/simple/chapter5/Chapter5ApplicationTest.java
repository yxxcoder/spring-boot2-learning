...
public class Chapter5ApplicationTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(Chapter5Application.class);
    @Autowired
    ...
    @Test
    public void testJDBcontroller() throws Exception {
