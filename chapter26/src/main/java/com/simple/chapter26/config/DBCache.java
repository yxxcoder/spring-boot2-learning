package com.simple.chapter26.config;


import com.simple.chapter26.entity.User;
import java.util.*;
...
public class DBCache {
    ...
    static {
        ...
        PERMISSIONS_CACHE.put("admin", Arrays.asList("user:find", "user:add", "user:edit"));
        PERMISSIONS_CACHE.put("test", Collections.singletonList("user:find"));
    }
